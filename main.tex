...
\title{home brewing for waterfall developers}
\subtitle{|}
\author{michał kret\footnote{\texttt{michal.b.kret@jpmchase.com}}}
...
\begin{frame}{copylefts}
    This presentation was made in \LaTeX using Beamer document class.
    
    Template DarkConsole made by Kazuki Maeda <kmaeda@kmaeda.net> and distributed on MIT license.
\end{frame}

\begin{frame}{beer development lifecycle}
  \tableofcontents
\end{frame}

\section{beer development lifecycle}
\begin{frame}{software development lifecycle}
      tu obrazek
\end{frame}

\begin{frame}{\st{software} beer development lifecycle}
      n obrazków do wersji z samym piwem
\end{frame}
